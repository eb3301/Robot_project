...
class MinimalService(Node):
    ...
    def inverse_kinematics(self,target_position):
        ...
        my_coords_phi_3 = -(phi_1-(math.radians(180)-phi_2))
        ...
        return self.transform_to_robot(ang)
    ...
    def arm_callback(self, request, response):
        target_position = [ 0.15, 0.1, -0.17] #assuming x right 
        ...
        robot_angles = self.inverse_kinematics(target_position)
