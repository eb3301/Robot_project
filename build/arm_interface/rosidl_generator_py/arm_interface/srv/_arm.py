...
class Metaclass_Arm_Event(type):
    """Metaclass of message 'Arm_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__arm__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__arm__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__arm__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__arm__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__arm__event
...
class Arm_Event(metaclass=Metaclass_Arm_Event):
    """Message class 'Arm_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<arm_interface/Arm_Request, 1>',
        'response': 'sequence<arm_interface/Arm_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['arm_interface', 'srv'], 'Arm_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['arm_interface', 'srv'], 'Arm_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from arm_interface.srv import Arm_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Arm_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Arm_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from arm_interface.srv import Arm_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Arm_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Arm_Response'"
...
class Metaclass_Arm(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from arm_interface.srv import _arm
            ...
            if _arm.Metaclass_Arm_Event._TYPE_SUPPORT is None:
                _arm.Metaclass_Arm_Event.__import_type_support__()


class Arm(metaclass=Metaclass_Arm):
    from arm_interface.srv._arm import Arm_Request as Request
    from arm_interface.srv._arm import Arm_Response as Response
    from arm_interface.srv._arm import Arm_Event as Event
